...
1.执行`npm install` 安装`http-server`
2.安装完成后执行`http-server`，即可开启本地服务器，在浏览器中输入`http://localhost:8080`访问

## 优化说明：

index.html:
在13-20行中，引入google的webfont.js，异步载入Google字体文件

main.js:

1、将代码中所有的querySelector替换为getElementById
2、在522行中，将left属性更换为transform
3、在470行中，使用requestAnimationFrame来运行动画
